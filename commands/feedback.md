---
name: feedback
description: Report a bug or send feedback about the mockup-gallery plugin
---

# Report mockup-gallery feedback
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/mockup-gallery/issues/new
